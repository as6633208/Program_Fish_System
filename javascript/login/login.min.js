        ...
        if (isPassValidateCode()) {//驗證成功
            $.ajax({
                ...
                success: function (e) {
                    ...
                    Cookies.set('user', e[0].Account, { expires: new Date().getTime() + 1000 * 60 * 30 });//設置cookie一天時間
                    Cookies.set('authority', e[0].authority, { expires: new Date().getTime() + 1000 * 60 * 30 });//設置cookie一天時間
                },
                error: function (e) {
