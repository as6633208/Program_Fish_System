...
public class measuring_delete : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        } else
        {
            ...
            string Measuring_Fish_AVGweight=context.Request.Form["Measuring_Fish_AVGweight"].ToString();
            string number = context.Request.Form["number"].ToString();
            Method_Fish method = new Method_Fish();
            string re_ = method.Measuring_delete(Pool_id,Fish_detail_id,id,Measuring_Fish_AVGweight,number);
